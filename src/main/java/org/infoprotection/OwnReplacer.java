...
public class OwnReplacer {
    ...
    private void encryptCipher(BufferedReader bufferedReader, BufferedWriter bufferedWriter, boolean isForEncrypt) {
        char[] ABC = {'А', 'Б', 'В', 'Г', 'Д', 'Е', 'Ё', 'Ж', 'З', 'И', 'Й', 'К', 'Л', 'М', 'Н', 'О', 'П', 'Р', 'С', 'Т', 'У', 'Ф', 'Х', 'Ц', 'Ч', 'Ш', 'Щ', 'Ъ', 'Ы', 'Ь', 'Э', 'Ю', 'Я', 'а', 'б', 'в', 'г', 'д', 'е', 'ё', 'ж', 'з', 'и', 'й', 'к', 'л', 'м', 'н', 'о', 'п', 'р', 'с', 'т', 'у', 'ф', 'х', 'ц', 'ч', 'ш', 'щ', 'ъ', 'ы', 'ь', 'э', 'ю', 'я', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0'};
        char[] cryptABC = {'н', 'С', 'з', '6', '4', '9', 'Я', 'л', 'й', 'м', 'р', 'Ы', 'т', 'в', '8', 'У', 'с', 'Ф', 'А', 'и', 'З', 'х', 'ю', 'Н', 'д', 'о', '7', 'Ч', 'е', 'Т', '3', 'Ц', 'Е', 'Ю', 'Щ', 'у', 'к', 'ц', 'г', '5', 'Ш', 'Ж', 'ъ', 'ё', 'я', 'Й', 'ф', 'щ', 'В', 'П', 'п', 'Д', 'Ё', 'К', 'И', 'б', 'Ь', 'Б', 'ч', 'О', 'ж', 'а', '1', 'Ъ', 'э', 'Х', '2', 'Г', 'Э', 'ш', '0', 'ы', 'Р', 'М', 'Л', 'ь'};
        String text;
